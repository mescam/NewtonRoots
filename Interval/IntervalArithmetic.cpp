...
interval IntervalArithmetic::IntRead(const std::string & sa)
{
	interval r;
	mpfr_t rop;
	mpfr_init2(rop, 80);
...
void IntervalArithmetic::IEndsToStrings(const interval & i, std::string & left,
        std::string & right)
{
    left = boost::lexical_cast<std::string>(i.a);
    right = boost::lexical_cast<std::string>(i.b);
}
